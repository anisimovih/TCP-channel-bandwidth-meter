...
# Form implementation generated from reading ui file 'gui_for_server.ui'
#
...
class Ui_server_window(object):
    def setupUi(self, server_window):
        ...
        self.change_to_client_buton = QtWidgets.QPushButton(self.centralwidget)
        self.change_to_client_buton.setObjectName("change_to_client_buton")
        self.gridLayout.addWidget(self.change_to_client_buton, 0, 3, 1, 1)
        self.cleint_server_choice = QtWidgets.QComboBox(self.centralwidget)
        self.cleint_server_choice.setObjectName("cleint_server_choice")
        self.gridLayout.addWidget(self.cleint_server_choice, 0, 2, 1, 1)
    ...
    def retranslateUi(self, server_window):
        ...
        self.change_to_client_buton.setText(_translate("server_window", "Change on client"))
